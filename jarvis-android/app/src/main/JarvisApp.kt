 ...
 * this sprint's "no business logic inside Composables" requirement.
 * Its only job is exposing the SharedFlow; JarvisApp does the actual
 * navController.navigate() call, since a ViewModel should not hold a
 * NavHostController reference either.
 */
@HiltViewModel
